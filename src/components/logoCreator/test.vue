            ...
            <div :class="{'ex theResultFont' : true, [x] : true }">
              <v-layout wrap justify-center>
                <v-flex xs12>
                  ...
                  <div style="margin-top:8px;margin-bottom:-8px">{{ $store.state.logoInfo.logoName }}</div>
                </v-flex>
              </v-layout>
            </div>
            <div v-if="$store.state.logoInfo.logoTagline.length > 0" :class="{[x] : true }" style="font-size:0.7em!important">
    ...
    test () {
      ...
      if (this.$store.state.logoInfo.typeOfLogo === 3) {
        ...
        if (!logoOne.innerHTML.includes('style="margin-top: 8px; margin-bottom: -8px;"')) {
          ...
          } else if (logoOne.innerHTML.includes('ex6')) {
            logoOne.innerHTML = logoOne.innerHTML.replace('style="margin-top: -20px; margin-bottom: 25px;"', 'style="margin-top: -7px; margin-bottom: 20px;"')
          }
        }
      }
      // --------- LogoTwo ---------
      ...
      if (this.$store.state.logoInfo.typeOfLogo === 3) {
        ...
        if (!logoTwo.innerHTML.includes('style="margin-top: 8px; margin-bottom: -8px;"')) {
          ...
          } else if (logoTwo.innerHTML.includes('ex6')) {
            logoTwo.innerHTML = logoTwo.innerHTML.replace('style="margin-top: -20px; margin-bottom: 25px;"', 'style="margin-top: -7px; margin-bottom: 20px;"')
          }
        }
      }
      // --------- LogoThree ---------
      ...
      if (this.$store.state.logoInfo.typeOfLogo === 3) {
        ...
        if (!logoThree.innerHTML.includes('style="margin-top: 8px; margin-bottom: -8px;"')) {
          ...
          } else if (logoThree.innerHTML.includes('ex6')) {
            logoThree.innerHTML = logoThree.innerHTML.replace('style="margin-top: -20px; margin-bottom: 25px;"', 'style="margin-top: -7px; margin-bottom: 20px;"')
          }
        }
      }
      // --------- LogoOne ---------
